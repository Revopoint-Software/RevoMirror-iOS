...
+(int) getConnectedGamepadMask:(RMI_StreamConfiguration*)streamConfig {
    int mask = 0;
    ...
    RMI_TemporarySettings* settings = [dataMan getSettings];
...
-(id) initWithConfig:(RMI_StreamConfiguration*)streamConfig delegate:(id<ControllerSupportDelegate>)delegate
{
    self = [super init];
